...
public class ErrorView_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.frontend.ui.pages.ErrorView"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ErrorView_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.polimi.travlendar.frontend.ui.pages.ErrorView",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.vaadin.navigator.ViewChangeListener$ViewChangeEvent", false, ErrorView_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ErrorView_ESTest_scaffolding.class.getClassLoader()); 
