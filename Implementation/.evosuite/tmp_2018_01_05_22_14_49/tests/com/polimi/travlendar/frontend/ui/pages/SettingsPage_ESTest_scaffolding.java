...
public class SettingsPage_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.frontend.ui.pages.SettingsPage"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SettingsPage_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.polimi.travlendar.frontend.ui.pages.SettingsPage",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.polimi.travlendar.backend.model.user.User", false, SettingsPage_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.polimi.travlendar.frontend.ui.forms.UpdateAccountForm", false, SettingsPage_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SettingsPage_ESTest_scaffolding.class.getClassLoader()); 
