...
public class WelcomePage_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.frontend.ui.pages.WelcomePage"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WelcomePage_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.polimi.travlendar.frontend.ui.pages.WelcomePage",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.vaadin.navigator.ViewChangeListener$ViewChangeEvent", false, WelcomePage_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WelcomePage_ESTest_scaffolding.class.getClassLoader()); 
