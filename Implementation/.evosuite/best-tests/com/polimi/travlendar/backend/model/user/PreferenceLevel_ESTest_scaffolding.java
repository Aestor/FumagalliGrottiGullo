...
public class PreferenceLevel_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.backend.model.user.PreferenceLevel"; 
  ...
  public void setSystemProperties() {
    ...
    java.lang.System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar7307739400931094740.jar"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PreferenceLevel_ESTest_scaffolding.class.getClassLoader() ,
      "com.polimi.travlendar.backend.model.user.PreferenceLevel"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PreferenceLevel_ESTest_scaffolding.class.getClassLoader()); 
