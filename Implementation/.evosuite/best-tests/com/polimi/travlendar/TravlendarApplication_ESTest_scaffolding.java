...
public class TravlendarApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.TravlendarApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TravlendarApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.polimi.travlendar.TravlendarApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TravlendarApplication_ESTest_scaffolding.class.getClassLoader()); 
