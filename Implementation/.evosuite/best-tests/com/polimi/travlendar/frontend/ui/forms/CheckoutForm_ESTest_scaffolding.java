...
public class CheckoutForm_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.polimi.travlendar.frontend.ui.forms.CheckoutForm"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CheckoutForm_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.polimi.travlendar.backend.beans.UserService", false, CheckoutForm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.polimi.travlendar.backend.model.user.User", false, CheckoutForm_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CheckoutForm_ESTest_scaffolding.class.getClassLoader()); 
