...
\caption{Account Creation Mock-Up}
\label{fig:MU1}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.2\linewidth]{02-Terms_and_conditions.png}
\caption{Terms And Conditions Mock-Up}
\label{fig:MU2}
\end{figure}
\begin{figure}[H]
\centering
